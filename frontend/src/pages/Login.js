...
function Login() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!remember) {
        // If not remembering, store in memory only for this session
    ...
    <div style={{ display: "flex", justifyContent: "center", padding: "40px 16px" }}>
      <div style={{ width: "100%", maxWidth: 420 }}>
        <div style={{ textAlign: "center", marginBottom: 16 }}>
          ...
          <div style={{ color: "#6b7280", marginTop: 4 }}>Sign in to your account</div>
        </div>
        ...
        <div style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 20, boxShadow: "0 1px 2px rgba(0,0,0,0.03)" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
              ...
              <button type="button" onClick={() => alert("Forgot password placeholder")} style={{ background: "transparent", border: 0, color: "#2563eb", cursor: "pointer" }}>Forgot password?</button>
            </div>
